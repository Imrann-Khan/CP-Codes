...
public:
    ...
    {
        //notice that we can pass a value of even private members of the parent class.
        AC_capcity_ton=a1;
        brand_name=b1;
        AC_type=c1;
    }
...
public:
    ...
    display()
    {
        ...
        //need c_str() if we want to print a C++ string with printf(). if we used cout, it wouldn;t be an issue.
        /* since productID is private is the "grandparent" class, obviously throughout the inheritance sequence,
         it is still private in this class and hence, we have to use a public function to access it */
    }
} ;
